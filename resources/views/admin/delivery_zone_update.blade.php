            ...
            <div class="card col-md-6">
                <div class="card-header">
                    <div class="d-flex">
                        ...
                        <h3 class="ml-0">Update Delivery Zone</h3>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.delivery-zone.update' , $zone->id ) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" value="{{$zone->name}}" name="name" required>
                        </div>


                        <div class="form-group">
                            <label for="price">Delivery Charge</label>
                            <input type="number" class="form-control" id="price" value="{{$zone->price}}" name="price" required>
                        </div>
